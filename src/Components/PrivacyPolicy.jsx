...
const PrivacyPolicy = () => {
  // Read in an effect rather than inline in the JSX: this renders on the
  // server too, where `window` does not exist.
  const [origin, setOrigin] = useState("");
  // Computed after mount, not during render. This page is statically
  // prerendered, so `new Date()` in the JSX baked the build date into the HTML
  // and the client then rendered today's — a text mismatch that surfaced as
  // React hydration error #418. Deriving it client-side keeps the original
  // behaviour (always today's date) without the mismatch.
  ...
  return (
    <main className="top">
      <Header
        title="Privacy Policy of Uniscaler"
        image="https://www.nueclear.com/assets/images/privacy-policy-banner-nueclear.jpg"
      />
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Uniscaler.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Uniscaler, accessible from{" "}
              <a
                href={origin}
